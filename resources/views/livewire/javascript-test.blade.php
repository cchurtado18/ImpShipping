<div>
    <h3 class="text-lg font-semibold text-gray-900 mb-4">JavaScript Test</h3>
    ...
    <div class="mb-4">
        ...
        <input type="text" id="sender_name" class="w-full px-3 py-2 border border-gray-300 rounded-md" value="{{ $sender_name }}">
    </div>

    <div class="mb-4">
        <label class="block text-sm font-medium text-gray-700 mb-2">Sender Phone</label>
        <input type="text" id="sender_phone" class="w-full px-3 py-2 border border-gray-300 rounded-md" value="{{ $sender_phone }}">
    </div>
    ...
    <script>
        document.addEventListener('livewire:init', () => {
            Livewire.on('client-selected', (data) => {
